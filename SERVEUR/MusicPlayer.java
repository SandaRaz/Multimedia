...
public class MusicPlayer{
    ...
    public MusicPlayer(DataInputStream dis) throws Exception{
    	this.dataInputStream = dis;
    ...
    public static MusicPlayer cloneMP(MusicPlayer mp){
        MusicPlayer retour = null;
        try{
            Class<?> mpclass = Class.forName(mp.getClass().getName());
            Constructor<?> mpConstr = mpclass.getConstructor(DataInputStream.class);
            Object clone = mpConstr.newInstance(mp.getDataInputStream());
            retour = (MusicPlayer) clone;
        }catch(Exception e){
            e.printStackTrace();
        }
        return retour;
